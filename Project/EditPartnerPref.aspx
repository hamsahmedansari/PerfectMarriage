<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditPartnerPref.aspx.cs" Inherits="PerfetMarriage_01March2018_.EditPartnerPref" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            <div class="my-Box p-2 mt-2">
                <h3 class="border-bottom-1-info p-2">Edit Your Prefered Partner's Basic And Lifestyle Info
                ...
                <div class="row form-group">
                    ...
                    <div class="col-sm-4">
                        <asp:DropDownList runat="server" ID="dpdAgeFrom" CssClass="form-control think-border">
                        </asp:DropDownList>
                    </div>
                    <div class="col-sm-2">
                        To:
                    ...
                    <div class="col-sm-4 text-center">
                        <asp:DropDownList runat="server" ID="dpdAgeTo" CssClass="form-control think-border">
                        </asp:DropDownList>
                    </div>
                </div>
                <div class="row form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <asp:Label Text="Please Enter Height" ID="errHeightRequired" Visible="false" runat="server" Style="color: #f30f0f;" />
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col-sm-2">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <asp:Label Text="Please Enter Community" ID="errCommunityRequired" Visible="false" runat="server" Style="color: #f30f0f;" />
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col-sm-2">
                    ...
                    <div class="col-sm-10">
                        <asp:DropDownList ID="dpdMotherTounge" runat="server" CssClass="form-control think-border">
                            <asp:ListItem disabled Selected>Select</asp:ListItem>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-sm-10">
                        <asp:TextBox runat="server" ID="txtEducationLevel" CssClass="form-control think-border" />
                        <asp:Label Text="Please Enter Education Level" Visible="false" ID="errEducationLvlRequired" runat="server" Style="color: #f30f0f;" />
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col-sm-2">
                        Education/Profession Field:
                    </div>
                    <div class="col-sm-10">
                        <asp:TextBox runat="server" ID="txtEducationField" CssClass="form-control think-border" />
                        <asp:Label Text="Please Enter Education Field" Visible="false" ID="errEducationFieldRequired" runat="server" Style="color: #f30f0f;" />
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col-12 text-center">
                        <asp:Button Text="Cancel" ID="btnCancel" runat="server" CssClass="btn btn-success" OnClick="btnCancel_Click" />
                        &nbsp;
                        &nbsp;
